...
namespace Lazy.Abp.WalletKit.Recharges
{
    ...
    [Route("/api/walletKit/recharge-histories/management")]
    public class RechargeHistoryAdminController : WalletKitController, IRechargeHistoryAdminAppService
    {
        private readonly IRechargeHistoryAdminAppService _service;

        public RechargeHistoryAdminController(IRechargeHistoryAdminAppService service)
        {
            _service = service;
        }
