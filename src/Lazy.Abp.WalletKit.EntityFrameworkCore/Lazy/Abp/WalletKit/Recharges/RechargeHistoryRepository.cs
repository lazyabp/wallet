...
{
    public class RechargeHistoryRepository : EfCoreRepository<IWalletKitDbContext, RechargeHistory, Guid>, IRechargeHistoryRepository
    {
        public RechargeHistoryRepository(IDbContextProvider<IWalletKitDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }

        public override async Task<IQueryable<RechargeHistory>> WithDetailsAsync()
        {
        ...
        public async Task<List<RechargeHistory>> GetListAsync(
            string sorting = null,
        ...
        protected async Task<IQueryable<RechargeHistory>> GetListQuery(
            Guid? userId = null,
            Guid? rechargeProductId = null,
            decimal? minPaidAmount = null,
            decimal? maxPaidAmount = null,
